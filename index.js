...
const [columnDefs] = useState([
    { field: 'RONumber', cellStyle: { color: 'blue' },
        headerName: 'RO',
        pinned: 'left',
        maxWidth: 100,
        minWidth: 100, 
        lockPinned: true,},
    { field: 'ROStatus', filter: 'agTextColumnFilter', 
        headerName: 'Status'},
    { field: 'CustomerName', 
        headerName: 'Customer', },
    { field: 'Advisor', filter: 'agTextColumnFilter'},
    { field: 'PromisedTime', 
        headerName: 'Promised', },
    { field: 'VIN', maxWidth: 200, minWidth: 200},
    { field: 'Vehicle' },
    ...
    { field: 'PayType', 
        ...
        resizable: false, 
        maxWidth: 60, 
        cellStyle: { align: 'center' }, suppressMenu: true,},
